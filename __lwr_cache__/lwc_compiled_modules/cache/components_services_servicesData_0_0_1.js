import _tmpl from "./servicesData.html";
...
const SERVICES_DATA = [{
  ...
  image: '/public/assets/services/implementation.svg'
  // className: 'icon blue'
}, {
  id: 2,
  ...
  image: '/public/assets/services/development.svg'
  ...
  image: '/public/assets/services/consulting.svg'
  ...
  image: '/public/assets/services/integration.svg'
  // className: 'icon red'
}, {
  id: 5,
  title: 'Salesforce Maintenance',
  color: 'green',
  description: 'To get constant help for resolving problems, hire a Salesforce developer from our agency.',
  image: '/public/assets/services/support.svg'
  ...
  image: '/public/assets/services/migration.svg'
  // className: 'icon purple'
}];
export default _registerComponent(SERVICES_DATA, {
  tmpl: _tmpl,
